...
namespace Tita_Elisa_Lab2.Data
{
    public class Tita_Elisa_Lab2Context : DbContext
    {
        ...
        public DbSet<Tita_Elisa_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Tita_Elisa_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Tita_Elisa_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
